...
async def list_tools() -> list[Tool]:
    return [
        Tool(
            ...
            description="Get latest stock quote for a symbol",
            inputSchema={
                "type": "object",
        ...
        Tool(
            name="get_recent_ticks",
            description="Get recent stock ticks",
            inputSchema={
                "type": "object",
                "properties": {
                    "symbol": {"type": "string"},
        ...
        Tool(
            name="get_stock_features",
            description="Get computed rolling features",
            inputSchema={
                "type": "object",
                "properties": {"symbol": {"type": "string"}},
                "required": ["symbol"],
        ...
        Tool(
            ...
            description="List recent market anomalies",
            inputSchema={
                "type": "object",
        ...
        Tool(
            ...
            description="Get pipeline component health",
            inputSchema={"type": "object", "properties": {}},
        ),
        Tool(
            name="list_tracked_symbols",
            description="List tracked stock symbols",
            inputSchema={"type": "object", "properties": {}},
        ),
        Tool(
            name="get_company_news",
            description="Get company news for a symbol",
            inputSchema={
                "type": "object",
                "properties": {
                    "symbol": {"type": "string"},
        ...
        Tool(
            name="find_news_related_to_anomaly",
            description="Find news correlated with an anomaly",
            inputSchema={
                "type": "object",
        ...
        Tool(
            name="summarize_stock_context",
            description="Summarize correlated market context",
            inputSchema={
                "type": "object",
                "properties": {"symbol": {"type": "string"}},
                "required": ["symbol"],
        ...
        Tool(
            ...
            description="Generate a market-wide brief",
            inputSchema={"type": "object", "properties": {}},
        ),
        Tool(
            name="explain_stock_move",
            description="Hero tool: explain a stock move with correlated news and anomalies",
            inputSchema={
                "type": "object",
                "properties": {"symbol": {"type": "string"}},
                "required": ["symbol"],
...
async def call_tool(name: str, arguments: dict) -> list[TextContent]:
    mapping = {
        ...
        "get_recent_ticks": lambda: tools_client.get_recent_ticks(
            arguments["symbol"], arguments.get("limit", 20)
        ),
        "get_stock_features": lambda: tools_client.get_stock_features(arguments["symbol"]),
        "detect_market_anomalies": lambda: tools_client.detect_market_anomalies(
        ...
        "get_company_news": lambda: tools_client.get_company_news(
            arguments["symbol"], arguments.get("limit", 10)
        ),
        ...
        "find_news_related_to_anomaly": lambda: tools_client.find_news_related_to_anomaly(
            arguments["anomaly_id"]
        ),
        "summarize_stock_context": lambda: tools_client.summarize_stock_context(
            arguments["symbol"]
        ),
    ...
    MCP_TOOL_CALLS.labels(tool=name).inc()
